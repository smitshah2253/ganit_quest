...
export const LoginScreen = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-[var(--color-bg)] p-4 relative overflow-hidden select-none">
      {/* Decorative saffron & green highlights */}
      ...
      >
        <div className="relative z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <label className="block text-slate-700 text-xs font-bold mb-2 tracking-wide uppercase">Password</label>
              <input 
                type="password" 
                value={password}
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-xs font-bold text-indigo-650 hover:text-orange-655 transition-colors">
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="space-y-3">
              ...
              <motion.button 
                ...
                className="w-full py-3.5 rounded-xl font-bold text-indigo-600 bg-indigo-50/50 hover:bg-indigo-50 transition-all border border-indigo-200 text-sm uppercase tracking-wide cursor-pointer"
              >
                🚀 Quick Play (Bypass Login)
              </motion.button>
            </div>
          </form>
          ...
          <motion.button 
            ...
            onClick={() => googleLogin()}
            type="button"
            className="mt-8 w-full py-3 px-4 rounded-xl font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm cursor-pointer text-sm"
          >
