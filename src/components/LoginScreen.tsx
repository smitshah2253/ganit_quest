...
export const LoginScreen = () => {
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        // Send token to backend or mock for now
      ...
      >
        <div className="relative z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <label className="block text-gray-700 text-xs font-bold mb-2 tracking-wide uppercase">Password</label>
              <input 
                type="password" 
                value={password}
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm font-semibold text-blue-500 hover:text-blue-700 transition-colors">
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="space-y-3">
              ...
              <motion.button 
                ...
                className="w-full py-3.5 rounded-xl font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors border border-blue-200 text-base"
              >
          ...
          <motion.button 
            ...
            onClick={() => googleLogin()}
            type="button"
            className="mt-8 w-full py-3.5 px-4 rounded-xl font-bold text-gray-700 bg-white border-2 border-gray-100 hover:bg-gray-50 hover:border-gray-200 transition-all flex items-center justify-center gap-3 shadow-sm"
          >
